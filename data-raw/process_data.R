...
datasets <- data.frame(
  ...
  study_design = c(
    ...
    "Cross-sectional baseline extract (n = 128) from an unidentified longitudinal study of injection drug users; the original study is not documented in the textbook or companion materials.",
  ...
  primary_article = c(
    ...
    "Cummings et al. (1995) New England Journal of Medicine",
    "RMB2e Georgia repeated-birth example",
    "Cummings et al. (1995) New England Journal of Medicine",
    "Primary source not documented in textbook or companion materials",
    "Black et al. (1996) The Lancet",
  ...
  primary_article_url = c(
    ...
    "https://regression.ucsf.edu/second-edition/data-examples-and-problems",
    "https://doi.org/10.1056/NEJM199503233321202",
    "https://regression.ucsf.edu/sites/g/files/tkssra16191/files/wysiwyg/home/data/needle_sharing.dta",
    "https://doi.org/10.1016/S0140-6736(96)07088-2",
    "https://regression.ucsf.edu/second-edition/data-examples-and-problems",
    "https://doi.org/10.1016/S0140-6736(96)07088-2",
    "https://doi.org/10.1001/jama.280.7.605",
