...
This vignette demonstrates an RMB2e-style modeling workflow for `hers_nodm_visit4_only`, with explicit demonstration of exploratory analysis, model specification, parameter estimation, adequacy checks, and scientific interpretation.
...
For `hers_nodm_visit4_only` we ask: what is the association between a primary exposure and an outcome,
