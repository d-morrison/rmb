...
Are depression diagnosis and homelessness associated with greater needle-sharing frequency among injection drug users?
...
Linear regression of log-transformed needle sharing (`logshsyr`) on depression diagnosis, homelessness, HIV status, polydrug use, and square-root injection frequency, following the transformed-outcome approach in RMB2e Chapter 8.
