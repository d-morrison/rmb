...
This vignette demonstrates an RMB2e-style modeling workflow for `fecfat`, with explicit demonstration of exploratory analysis, model specification, parameter estimation, adequacy checks, and scientific interpretation.
...
For `fecfat` we ask: what is the association between a primary exposure and an outcome,
