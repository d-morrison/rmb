...
This vignette demonstrates an RMB2e-style modeling workflow for `mira_hsv`, with explicit demonstration of exploratory analysis, model specification, parameter estimation, adequacy checks, and scientific interpretation.
...
For `mira_hsv` we ask: what is the association between a primary exposure and an outcome,
