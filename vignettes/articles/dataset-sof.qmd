...
This vignette demonstrates an RMB2e-style modeling workflow for `sof`, with explicit demonstration of exploratory analysis, model specification, parameter estimation, adequacy checks, and scientific interpretation.
...
For `sof` we ask: what is the association between a primary exposure and an outcome,
