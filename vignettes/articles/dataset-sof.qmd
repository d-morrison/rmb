...
dat <- sof
dim(dat)
baseline_sof <- subset(dat, visit == 1)
dim(baseline_sof)
...
A linear regression model is fitted at the baseline visit (visit 1) to estimate the cross-sectional association between BMI and total BMD, adjusting for age and menopausal age. Using only baseline visits avoids correlation from repeated measurements (RMB2e Ch. 7).
